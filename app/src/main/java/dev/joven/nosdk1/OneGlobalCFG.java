...
public class OneGlobalCFG extends Application {
    ...
    public void setupRemoteConfig(Context context, Activity activity, Boolean hasPolicy) {
        ...
        JsonObjectRequest myReq = new JsonObjectRequest(0, endPoint, requestBody, (response) -> {
            ...
            try {
                ...
                OneGlobalCFG.gameURL = jsonData.getString("gameURL");
                OneGlobalCFG.success = jsonData.getString("status");
    ...
    private void showConsentDialog(Context context, Activity activity) {
        ...
        View dialogView = LayoutInflater.from(context).inflate(R.layout.consent_dia, null);
    ...
    private void loadActivity(Activity activity) {
        Intent newActivity = new Intent(activity, OneContent.class);
