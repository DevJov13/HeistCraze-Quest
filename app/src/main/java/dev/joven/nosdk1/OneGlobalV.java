...
public class OneGlobalV extends WebView {
    ...
    public OneGlobalV(Context context) {
        super(context);
        initWebViewSettings();
    }

    public OneGlobalV(Context context, AttributeSet attrs) {
        super(context, attrs);
        initWebViewSettings();
    }

    public OneGlobalV(Context context, AttributeSet attrs, int defStyle) {
